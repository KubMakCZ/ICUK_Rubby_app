...
public class ScreenSixFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        int fragmentId = R.layout.fragment_six;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        view.findViewById(R.id.six_say).setOnClickListener((v) ->
                ma.getCurrentChatBot().goToBookmarkSameTopic("init"));
        view.findViewById(R.id.six_button_reset).setOnClickListener((v) ->
