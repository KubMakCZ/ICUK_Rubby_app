...
public class ScreenEightFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        int fragmentId = R.layout.fragment_eight;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        view.findViewById(R.id.eight_say).setOnClickListener((v) ->
                ma.getCurrentChatBot().goToBookmarkSameTopic("init"));
        view.findViewById(R.id.eight_button_reset).setOnClickListener((v) ->
