...
public class ScreenThreeFragment extends Fragment {
    ...
    private static final String TAG = "MSI_ScreenThreeFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        int fragmentId = R.layout.fragment_three;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        view.findViewById(R.id.three_say).setOnClickListener((v) ->
                ma.getCurrentChatBot().goToBookmarkSameTopic("init"));
        view.findViewById(R.id.three_button_reset).setOnClickListener((v) ->
